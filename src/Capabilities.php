...
final class Capabilities {
	...
	public static function ensure_granted(): void {
		if ( get_option( 'event_ticket_scanner_caps_granted' ) === EVENT_TICKET_SCANNER_VERSION && get_role( Plugin::ROLE_SCANNER ) ) {
			return;
		}

		self::grant();
		update_option( 'event_ticket_scanner_caps_granted', EVENT_TICKET_SCANNER_VERSION, false );
	}
